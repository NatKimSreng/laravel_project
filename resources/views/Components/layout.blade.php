        ...
        <nav class="bg-gray-800">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden md:block">
                    ...
                    <x-navlink href="/job" :active="request()->is('jobs')">Job</x-navlink>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div>
                        ...
                        <img class="size-8 rounded-full" src="https://avatars.githubusercontent.com/u/199746020?v=4" alt="">
                        </button>
                    </div>
                    </div>
                </div>
            ...
            <div class="border-t border-gray-700 pt-4 pb-3">
                ...
                <div class="shrink-0">
                    <img class="size-10 rounded-full" src="https://avatars.githubusercontent.com/u/199746020?v=4" alt="">
                </div>
                <div class="ml-3">
